 ...
 * @author Manish Rai
 */
public class TransectionHistory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ACCOUNT NO", "AMOUNT", "DATE", "TIME", "STATES"
            }
        ));
        ...
        jScrollPane1.setBounds(180, 260, 1010, 340);
        ...
        jButton1.setBounds(440, 630, 210, 50);

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel6.setText("Account No :");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(540, 210, 120, 30);
        jPanel1.add(jTextField1);
        jTextField1.setBounds(700, 210, 200, 30);
        ...
        jButton2.setBounds(700, 630, 230, 50);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            stm = con.createStatement();
            ResultSet r = stm.executeQuery("select * from TRANSECTIONHISTORY where ACC_NO=" + i + "");
            if (r.next() == false) {
                JOptionPane.showMessageDialog(this, "RECORD IS NOT FOUND");
            } else {
                ResultSet r1 = stm.executeQuery("select * from TRANSECTIONHISTORY where ACC_NO=" + i + "");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            int i2 = Integer.parseInt(jTextField1.getText());
            stm = con.createStatement();
            ResultSet r2 = stm.executeQuery("select * from TRANSECTIONHISTORY where ACC_NO=" + i2 + "");
            if (r2.next() == false) {
                JOptionPane.showMessageDialog(this, "RECORD IS NOT FOUND");
            } else {
                ...
                ResultSet r3 = stm.executeQuery("select * from TRANSECTIONHISTORY where ACC_NO=" + i2 + "");
                ...
                if (file.exists()) {
                    ...
                    if (i4 == 0) {
                        ...
                        while (r3.next()) {
                            ...
                            bw.newLine();
                            bw.write(String.valueOf(r3.getInt("ACC_NO")) + "        " + String.valueOf(r3.getDouble("AMOUNT")) + "      " + r3.getDate("DATE") + "      " + r3.getTime("TIME") + "     " + r3.getString("STATES"));
                        }
                        bw.close();
                        fw.close();
                    ...
                    bw.newLine();
                    bw.write("ACCOUNT NO" + "    " + "AMOUNT" + "       " + "DATE" + "           " + "TIME" + "         " + "STATUS" + "  ");
                    bw.newLine();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransectionHistory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TransectionHistory().setVisible(true);
            }
        });
    }
