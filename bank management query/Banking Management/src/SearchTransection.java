 ...
 * @author Rajeev Yadav
 */
public class SearchTransection extends javax.swing.JFrame {
   ...
   Statement stm;
    ...
    int n,n2;
    /**
     * Creates new form SearchTransection
     */
    public SearchTransection() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel1);
        jLabel1.setBounds(320, 60, 530, 58);
        ...
        jLabel7.setText("CITY BANK");
        jPanel3.add(jLabel7);
        jLabel7.setBounds(330, 20, 190, 30);

        jPanel2.add(jPanel3);
        jPanel3.setBounds(145, 0, 1220, 180);
        ...
        jScrollPane1.setBounds(210, 280, 1010, 330);
        ...
        jButton1.setBounds(480, 640, 210, 50);

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel6.setText("Account No :");
        jPanel2.add(jLabel6);
        jLabel6.setBounds(500, 210, 160, 50);
        jPanel2.add(jTextField1);
        jTextField1.setBounds(670, 220, 230, 40);
        ...
        jButton2.setBounds(740, 640, 215, 50);

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel2, javax.swing.GroupLayout.DEFAULT_SIZE, 1363, Short.MAX_VALUE)
        );
        ...
        setSize(new java.awt.Dimension(1363, 745));
    ...
    private void jLabel3MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseEntered
        jPanel6.setBackground(java.awt.Color.ORANGE);        // TODO add your handling code here:
    }//GEN-LAST:event_jLabel3MouseEntered

    private void jLabel3MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseExited
        jPanel6.setBackground(java.awt.Color.CYAN);        // TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ResultSet r =   stm.executeQuery("select * from TRANSECTION WHERE TO_ACCOUNT="+n+" OR FROM_ACCOUNT="+n+" ");
            if(r.next()==false)
            {
                JOptionPane.showMessageDialog(this,"INVALIED ACCOUNT");
            }
            else
            {
                ResultSet r1 =   stm.executeQuery("select * from TRANSECTION WHERE TO_ACCOUNT="+n+" OR FROM_ACCOUNT="+n+" ");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        stm = con.createStatement();
            ResultSet r2 = stm.executeQuery("select * from TRANSECTION WHERE TO_ACCOUNT="+n2+" OR FROM_ACCOUNT="+n2+"");
            if (r2.next() == false) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchTransection.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchTransection().setVisible(true);
            }
        });
    }
